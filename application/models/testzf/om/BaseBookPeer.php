...
abstract class BaseBookPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'AutorId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'autorId', ),
        BasePeer::TYPE_COLNAME => array (BookPeer::ID, BookPeer::NAME, BookPeer::AUTOR_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'AUTOR_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'autor_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'AutorId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'autorId' => 2, ),
        BasePeer::TYPE_COLNAME => array (BookPeer::ID => 0, BookPeer::NAME => 1, BookPeer::AUTOR_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'AUTOR_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'autor_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(BookPeer::AUTOR_ID);
        } else {
    ...
    public static function doCountJoinAutor(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(BookPeer::AUTOR_ID, AutorPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Book objects pre-filled with their Autor objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAutor(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Book) to $obj2 (Autor)
                $obj2->addBook($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Book) to the collection in $obj2 (Autor)
                $obj2->addBook($obj1);
