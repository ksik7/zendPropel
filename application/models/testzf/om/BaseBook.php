...
abstract class BaseBook extends BaseObject implements Persistent
{
    ...
    public function setAutorId($v)
    {
        ...
        if ($this->autor_id !== $v) {
            $this->autor_id = $v;
            $this->modifiedColumns[] = BookPeer::AUTOR_ID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BookPeer::AUTOR_ID)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setAutorId($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookPeer::AUTOR_ID)) $criteria->add(BookPeer::AUTOR_ID, $this->autor_id);
