...
/**
 * Base class that represents a query for the 'autors' table.
 *
 *
 *
 * @method AutorQuery orderById($order = Criteria::ASC) Order by the id column
 * @method AutorQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method AutorQuery groupById() Group by the id column
 * @method AutorQuery groupByName() Group by the name column
 *
 ...
 *
 * @method AutorQuery leftJoinBook($relationAlias = null) Adds a LEFT JOIN clause to the query using the Book relation
 * @method AutorQuery rightJoinBook($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Book relation
 * @method AutorQuery innerJoinBook($relationAlias = null) Adds a INNER JOIN clause to the query using the Book relation
 *
 ...
 *
 * @method Autor findOneByName(string $name) Return the first Autor filtered by the name column
 *
 * @method array findById(int $id) Return Autor objects filtered by the id column
 * @method array findByName(string $name) Return Autor objects filtered by the name column
 *
...
abstract class BaseAutorQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `name` FROM `autors` WHERE `id` = :p0';
        try {
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AutorPeer::NAME, $name, $comparison);
    }
    ...
    public function filterByBook($book, $comparison = null)
    {
        if ($book instanceof Book) {
            return $this
                ->addUsingAlias(AutorPeer::ID, $book->getAutorId(), $comparison);
     ...
     *
     * @return    Autor the result, formatted by the current formatter
     */
